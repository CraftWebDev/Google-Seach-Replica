# This is a project to create a Google Search replica website using HTML and CSS that includes three pages - regular Google Search, Google Image Search,  and Google Advanced Search. 
